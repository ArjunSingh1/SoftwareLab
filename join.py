...
def main():
	with open('games_lists\latest_games_lists\PS4_Games', mode='r', newline='\n') as PS4_file:
		add_to_dictionary(file=PS4_file, platform='PS4')
	with open('games_lists\latest_games_lists\PS3_Games', mode='r', newline='\n') as PS3_file:
		add_to_dictionary(file=PS3_file, platform='PS3')
	with open('games_lists\latest_games_lists\Switch_Games', mode='r', newline='\n') as Switch_file:
		add_to_dictionary(file=Switch_file, platform='Switch')
	with open('games_lists\latest_games_lists\WiiU_Games', mode='r', newline='\n') as Wii_file:
		add_to_dictionary(file=Wii_file, platform='WiiU')
	with open('games_lists\latest_games_lists\Xbox360_Games', mode='r', newline='\n') as Xbox360_file:
		add_to_dictionary(file=Xbox360_file, platform='Xbox360')
	with open('games_lists\latest_games_lists\XboxOne_Games', mode='r', newline='\n') as XboxOne_file:
...
def put_dictionary_in_csv():
	with open('games_lists\latest_games_lists\All_Games.csv', mode='w', encoding='utf-8') as file:
